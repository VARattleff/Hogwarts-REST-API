...
public class TeacherDTO {
    ...
    public TeacherDTO(String firstName, String middleName, String lastName, String house, boolean headOfHouse, EmpType employment, LocalDate employmentStart, LocalDate employmentEnd) {
